...
export const TOOLS = [
  {
    ...
    halfWidth: 0.10, power: 1.0, precision: 0.6, maxStep: 0.05,
  ...
  },
  {
    ...
    halfWidth: 0.16, power: 0.7, precision: 0.5, maxStep: 0.04,
    color: 0xa9b0b6, cost: 0, unlockLevel: 1,
    icon: '▭', desc: 'Wide and gentle. Great for fairing long, flat tapers.',
    shapeOffset: (d, hw) => 0,
  },
  {
    id: 'roughing', name: 'Roughing Gouge', kind: 'cut',
    halfWidth: 0.20, power: 1.7, precision: 0.35, maxStep: 0.07,
    color: 0xc9a36b, cost: 150, unlockLevel: 2,
    icon: '◗', desc: 'Hogs away bulk material fast. Low precision — rough work only.',
    shapeOffset: (d, hw) => 0.18 * (d * d) / (hw * hw),
  },
  {
    id: 'gouge', name: 'Curved Gouge', kind: 'cut',
    halfWidth: 0.13, power: 1.1, precision: 0.7, maxStep: 0.06,
  ...
  },
  {
    ...
    halfWidth: 0.035, power: 1.25, precision: 0.85, maxStep: 0.18,
    color: 0xd0d6db, cost: 300, unlockLevel: 3,
    icon: '▽', desc: 'Narrow and deep. Cuts crisp grooves, beads and shoulders.',
    shapeOffset: (d, hw) => 0.9 * (d / hw),
  },
  {
    id: 'detail', name: 'Detail Carver', kind: 'cut',
    halfWidth: 0.05, power: 0.9, precision: 0.95, maxStep: 0.13,
  ...
  },
  {
    ...
    halfWidth: 0.09, power: 2.1, precision: 0.8, maxStep: 0.09,
  ...
  },
  {
    ...
    halfWidth: 0.18, power: 1.0, precision: 0.5,
  ...
  },
  {
    ...
    halfWidth: 0.26, power: 1.0, precision: 0.6,
